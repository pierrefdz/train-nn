...
import main_train as main_train
import submitit


def parse_args():
    main_train_parser = main_train.get_args_parser()
    parser = argparse.ArgumentParser("Submitit", parents=[main_train_parser])
...
def main():
    ...
    executor.update_parameters(name="resnet18")
